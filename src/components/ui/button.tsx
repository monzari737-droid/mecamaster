  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        user: "bg-emerald-500 text-white hover:bg-emerald-600",
        mechanic: "bg-blue-500 text-white hover:bg-blue-600",
        enterprise: "bg-orange-500 text-white hover:bg-orange-600",
        sos: "bg-red-500 text-white hover:bg-red-600 animate-pulse-sos",
      },
      size: {
        ...
        "2xl": "h-16 rounded-xl px-10 text-lg",
      },
    },
    defaultVariants: {
      variant: "default",
